...
from medallion.gold.gold_edge_ppi import run_gold_edge_ppi, run_gold_edge_ppi_geo
...
with DAG(
    ...
    gold_edge_ppi_geo = PythonOperator(
        task_id="gold_edge_ppi_geo",
        python_callable=run_gold_edge_ppi_geo,
    )
    ...
    silver_geo_nodes >> gold_edge_ppi_geo
